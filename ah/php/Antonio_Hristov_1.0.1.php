...
OPTIMIZAR/REUTILIZAR CÓDIGO PHP FRECUENTE, DE FORMA PARAMETRIZADA/PERSONALIZABLE
...
* ESCRIBIR ESTA VERSIÓN EN LA DOCUMENTACIÓN Y LA SIGUIENTE EN OBJETIVOS
* ACTUALIZAR TEXTO DE UTILIDAD EN LA DOCUMENTACIÓN
* ACTUALIZAR COMENTARIOS DE LA FUNCIÓN devolver_array_definido_ahphp (MAYÚSCULAS)
* INICIO REVISIÓN DE LA FUNCIÓN devolver_array_eliminar_posicion_ahphp
* ACTUALIZAR VALOR DE LAS CONSTANTES 
definir_array_ahphp, no_definir_array_ahphp, con_detalles_ahphp, sin_detalles_ahphp
* AÑADIR FUNCIONES NO OFICIALES PARA EXAMEN PHP
...
HACER OFICIAL LA VERSIÓN 1.0.2 
...
ACTUALIZAR CONTANTES ATRIBUTOS HTML POR TERMINAR EN "="
ACTUALIZAR FUNCIONES escribir_formulario_abrir_ahphp y escribir_formulario_abrir_simple_ahphp
...
escribir_formulario_abrir_ahphp($id="", $name="", $class="", $ruta_action="", $es_metodo_get=true);
escribir_formulario_abrir_simple_ahphp($ruta_action="", $es_metodo_get=true);
...
const definir_array_ahphp = verdadero_ahphp;
const no_definir_array_ahphp = falso_ahphp;
const con_detalles_ahphp = verdadero_ahphp;
const sin_detalles_ahphp = falso_ahphp;
const ordenar_array_ahphp = verdadero_ahphp;
const no_ordenar_array_ahphp = falso_ahphp;
...
const atributo_id_con_igual_ahphp = "id=";
const atributo_name_ahphp = "name";
const atributo_name_con_igual_ahphp = "name=";
const atributo_class_ahphp = "class";
const atributo_class_con_igual_ahphp = "class=";
const atributo_value_ahphp = "value";
const atributo_value_con_igual_ahphp = "value=";
const atributo_min_ahphp = "min";
const atributo_min_con_igual_ahphp = "min=";
const atributo_max_ahphp = "max";
const atributo_max_con_igual_ahphp = "max=";
// FIN ATRIBUTOS HTML
...
SOLO EN EL CASO DE QUE EL 1º PARÁMETRO array NO ESTÉ DEFINIDO TE DA LA OPCIÓN DE DEFINIRLO O DEJARLO SIN DEFINIR.
...
FUNCIÓN devolver_array_eliminar_posicion_ahphp


¿CÓMO FUNCIONA?

//
TE DEVUELVE EL ARRAY QUE ENVIES POR PARAMETRO
ELIMINANDO EL CONTENIDO DE LA POSICION DEL ARRAY ESPECIFICADO
CON LA OPCION DE ELIMINARLO INCLUIDO LA POSICION O
MANTENER LA POSICION Y ORDENARLO. 

SI LA POSICION A ELIMINAR NO EXISTE TE DEVUELVE EL ARRAY NORMAL.
...
*/
function devolver_array_eliminar_posicion_ahphp
(
    $array = valor_array_vacio_ahphp
    , 
    $posicion_eliminar = primera_posicion_ahphp
    , 
    $ordenar_array = ordenar_array_ahphp
    /*
    , 
    $devolver = true
    */
):array
{
    ...
    $array_auxiliar = valor_array_no_definido_ahphp; // $array
    ...
    if($ordenar_array)
    {
        foreach ($array as $posicion => $valor)
        {
            ...
            if(  $posicion < $posicion_eliminar  )
            {
                $array_auxiliar[$posicion] = $array[$posicion];
            }
            else if (  devolver_array_posicion_definido_ahphp($array, $posicion+1) && $array[$posicion+1] !== nulo_ahphp  )
            {
                $array_auxiliar[$posicion] = $array[$posicion+1];
            }
        }
...
*/
function escribir_formulario_abrir_ahphp($id="", $name="", $class="", $ruta_action="", $es_metodo_get=true)
{
    if(   devolver_condicion_valores_distintos_ahphp($es_metodo_get, true)   )
    {
    ...
    {
        escribir_ahphp('<form id="'.$id.'" name="'.$name.'" class="'.$class.'" action="'.$ruta_action.'" method="get"   >');
    }
}
//
...
*/
function escribir_formulario_abrir_simple_ahphp($ruta_action="", $es_metodo_get=true)
{
    if(   devolver_condicion_valores_distintos_ahphp($es_metodo_get, true)   )
    {
    ...
    {
        escribir_ahphp('<form action="'.$ruta_action.'" method="get"   >');
    }
}
//
...
function devolver_contenido_fichero_como_string_ahphp(string $ruta_fichero=""):string
{
    return file_get_contents($ruta_fichero);
    /*
...
function aniadir_contenido_fichero_ahphp(string $ruta_fichero="", $contenido="")
{
    return file_put_contents($ruta_fichero, $contenido, FILE_APPEND);
    /*
    file_put_contents
    (
        "temazos.csv",
...
function editar_contenido_fichero_ahphp(string $ruta_fichero="", $contenido="")
{
    // Falta probar
    return file_put_contents($ruta_fichero, $contenido);


    /*
    Posible alternativa a probar
    eliminar_fichero_ahphp($ruta_fichero);
    aniadir_contenido_fichero_ahphp($ruta_fichero, $contenido);
    */
}



function eliminar_fichero_ahphp(string $ruta_fichero="", $contexto=null)
{
    unlink($ruta_fichero, $contexto);
}



function devolver_array_de_string_separado_por_caracteres_delimitador_ahphp(string $texto="", string $caracteres_delimitador=""):array
{
    //$lines = explode("\n", $data);
    return explode($caracteres_delimitador, $texto);
}



function devolver_string_de_array_separado_por_caracteres_delimitador_ahphp(array $array=array(), string $caracteres_delimitador=""):string
{
    //$array = implode(':', $array);
    return implode($caracteres_delimitador, $array);
}



function devolver_conexion_base_datos_pdo_ahphp(string $nombre_db="", string $usuario="", string $contrasenia="", string $host="localhost", array $options=array())
{
    if( !devolver_array_definido_ahphp($options) )
    {
        $options = [
    ...
    //$mbd = new PDO('mysql:host=localhost;dbname=mibasededatos', "ah", "ah", $options);
    return new PDO("mysql:host=$host;dbname=$nombre_db", "$usuario", "$contrasenia", $options);
}



function devolver_array_query_base_datos_pdo_ahphp($conexion_base_datos_pdo=null, string $consulta_sql="")
{
    //$conexion_base_datos_pdo->query('SELECT * FROM Ciclistas');
    return $conexion_base_datos_pdo->query($consulta_sql);
    /*
        A ese array resultado aplicar:
        ...
        try 
        {
            ...
            {
                $valor['nombre_campo_de_tabla, como id, nombre, num_trofeos, etc'];
            }
